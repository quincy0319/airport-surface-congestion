...
window_count_feb_per15 <- data.frame(dep_count_feb_per15, arr_count_feb_per15, 
	pb_count_feb_per15, heavy_dep_feb_per15, heavy_arr_feb_per15)
...
heavy_dep_feb_per_dep <- vector(mode = "numeric", length = 0)
heavy_arr_feb_per_dep <- vector(mode = "numeric", length = 0)
for (i in 1:length(dep_window_feb_per15)) {
	a <- dep_window_feb_per15[i]
	...
	heavy_dep_feb_per_dep[i] <- heavy_dep_feb_per15[a]
	heavy_arr_feb_per_dep[i] <- heavy_arr_feb_per15[a]
}
# 为降落航班添加
...
heavy_dep_feb_per_arr <- vector(mode = "numeric", length = 0)
heavy_arr_feb_per_arr <- vector(mode = "numeric", length = 0)
for (i in 1:length(arr_window_feb_per15)) {
	...
	heavy_dep_feb_per_arr[i] <- heavy_dep_feb_per15[a]
	heavy_arr_feb_per_arr[i] <- heavy_arr_feb_per15[a]
}
...
dep_feb <- cbind(dep_origin_feb,
		 ...
		 data.frame(heavy_dep_feb_per_dep),
		 data.frame(heavy_arr_feb_per_dep))
arr_feb <- cbind(arr_origin_feb,
		 ...
		 data.frame(heavy_dep_feb_per_arr),
		 data.frame(heavy_arr_feb_per_arr))
...
window_count_mar_per15 <- data.frame(dep_count_mar_per15, arr_count_mar_per15, 
	pb_count_mar_per15, heavy_dep_mar_per15, heavy_arr_mar_per15)
...
heavy_dep_mar_per_dep <- vector(mode = "numeric", length = 0)
heavy_arr_mar_per_dep <- vector(mode = "numeric", length = 0)
for (i in 1:length(dep_window_mar_per15)) {
	a <- dep_window_mar_per15[i]
	...
	heavy_dep_mar_per_dep[i] <- heavy_dep_mar_per15[a]
	heavy_arr_mar_per_dep[i] <- heavy_arr_mar_per15[a]
...
heavy_dep_mar_per_arr <- vector(mode = "numeric", length = 0)
heavy_arr_mar_per_arr <- vector(mode = "numeric", length = 0)
for (i in 1:length(arr_window_mar_per15)) {
	...
	heavy_dep_mar_per_arr[i] <- heavy_dep_mar_per15[a]
	heavy_arr_mar_per_arr[i] <- heavy_arr_mar_per15[a]
}
...
dep_mar <- cbind(dep_origin_mar,
		 ...
		 data.frame(heavy_dep_mar_per_dep),
		 data.frame(heavy_arr_mar_per_dep))
arr_mar <- cbind(arr_origin_mar,
		 ...
		 data.frame(heavy_dep_mar_per_arr),
		 data.frame(heavy_arr_mar_per_arr))
...
window_count_apr_per15 <- data.frame(dep_count_apr_per15, arr_count_apr_per15, 
	pb_count_apr_per15, heavy_dep_apr_per15, heavy_arr_apr_per15)
...
heavy_dep_apr_per_dep <- vector(mode = "numeric", length = 0)
heavy_arr_apr_per_dep <- vector(mode = "numeric", length = 0)
for (i in 1:length(dep_window_apr_per15)) {
	a <- dep_window_apr_per15[i]
	...
	heavy_dep_apr_per_dep[i] <- heavy_dep_apr_per15[a]
	heavy_arr_apr_per_dep[i] <- heavy_arr_apr_per15[a]
...
heavy_dep_apr_per_arr <- vector(mode = "numeric", length = 0)
heavy_arr_apr_per_arr <- vector(mode = "numeric", length = 0)
for (i in 1:length(arr_window_apr_per15)) {
	...
	heavy_dep_apr_per_arr[i] <- heavy_dep_apr_per15[a]
	heavy_arr_apr_per_arr[i] <- heavy_arr_apr_per15[a]
...
dep_apr <- cbind(dep_origin_apr,
		 ...
		 data.frame(heavy_dep_apr_per_dep),
		 data.frame(heavy_arr_apr_per_dep))
arr_apr <- cbind(arr_origin_apr,
		 ...
		 data.frame(heavy_dep_apr_per_arr),
		 data.frame(heavy_arr_apr_per_arr))
...
window_count_may_per15 <- data.frame(dep_count_may_per15, arr_count_may_per15, 
	pb_count_may_per15, heavy_dep_may_per15, heavy_arr_may_per15)
...
heavy_dep_may_per_dep <- vector(mode = "numeric", length = 0)
heavy_arr_may_per_dep <- vector(mode = "numeric", length = 0)
for (i in 1:length(dep_window_may_per15)) {
	a <- dep_window_may_per15[i]
	...
	heavy_dep_may_per_dep[i] <- heavy_dep_may_per15[a]
	heavy_arr_may_per_dep[i] <- heavy_arr_may_per15[a]
}
# 为降落航班添加
...
heavy_dep_may_per_arr <- vector(mode = "numeric", length = 0)
heavy_arr_may_per_arr <- vector(mode = "numeric", length = 0)
for (i in 1:length(arr_window_may_per15)) {
	...
	heavy_dep_may_per_arr[i] <- heavy_dep_may_per15[a]
	heavy_arr_may_per_arr[i] <- heavy_arr_may_per15[a]
}
...
dep_may <- cbind(dep_origin_may,
		 ...
		 data.frame(heavy_dep_may_per_dep),
		 data.frame(heavy_arr_may_per_dep))
arr_may <- cbind(arr_origin_may,
		 ...
		 data.frame(heavy_dep_may_per_arr),
		 data.frame(heavy_arr_may_per_arr))
