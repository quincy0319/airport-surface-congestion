...
dep_36l_feb_finished <- read.csv("dep_36l_feb_finished.csv")
...
dep_36r_feb_finished <- read.csv("dep_36r_feb_finished.csv")
...
dep_01_feb_finished <- read.csv("dep_01_feb_finished.csv")
